import sys
sys.path.append('VFIFlowFormerPlusPlus-main/core')
...
if __name__ == '__main__':
    ...
    flow_img = flow_viz.flow_to_image(flow)  # Convert optical flow to a visualization image
    flow_image = Image.fromarray(flow_img)   # Convert the NumPy array to a PIL image
    flow_image.save(args.output.replace('.flo', '.png'))
